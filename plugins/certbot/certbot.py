...
CERTBOT_TEMPLATE = {
    'cert_paths': os.environ.get('CERBOT_CERT_PATHS', '').split(','),
    'certbot': os.environ.get('CERTBOT_EXEC', '/path/to/certbot-auto'),
    'channel': os.environ.get('CERTBOT_CHANNEL', '#general'),
}
